...
import { products } from '@/app/component/secondData'
...
export default function HomeSearch() {
    const productCart = products.map(product => (
        <section key={product.id} className="flex flex-col items-center hover:shadow-2xl align-center justify-center content-center border border-solid   rounded-[20px]" >
          ...
          <div className='flex justify-center border-b-2 border-solid w-[inherit] '>
            ...
            <Image src={`https://robohash.org/${product.id}`} alt={product.name} width={300} height={200}/>
